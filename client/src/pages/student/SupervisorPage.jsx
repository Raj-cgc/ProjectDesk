...
const SupervisorPage = () => {
  ...
  const { supervisor, project, supervisors } = useSelector(
    (state) => state.student,
  );
  ...
  const formattedDeadline = (dateStr) => {
    if (!dateStr) return "-";
  ...
  const submitRequest = () => {
    ...
    dispatch(
      requestSupervisor({ supervisorId: selectedSupervisor._id, message }),
    );
  };
      ...
      <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <span
                        className={`inline-flex items-center px-3 py-1 rounded-full font-medium capitalize text-sm ${project.status === "approved" ? "bg-green-100 text-green-800" : project.status === "pending" ? "bg-yellow-100 text-yellow-800" : project.status === "rejected" ? "bg-red-100 text-red-800" : "bg-gray-100 text-gray-800"}`}
                      >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-lg font-semibold text-slate-800 mt-1">
                      {project?.deadline
                        ? formattedDeadline(project.deadline)
                        : "No deadline set"}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-lg font-semibold text-slate-800 mt-1">
                      {project?.createdAt
                        ? formattedDeadline(project.createdAt)
                        : "Unknown"}
                    </p>
                  </div>
                </div>
        ...
        {!hasProject && (
          <div className="card">
            ...
            <div className="p-6 text-center">
              <p className="text-slate-600 text-lg">
                You havent't submitted any project proposal yet, so you cannot
